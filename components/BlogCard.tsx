...
function BlogCard({
  ...
  return (
    <div className="flex-col lg:flex-row flex space-y-8 lg:space-y-0 justify-between border shadow-lg rounded-2xl lg:hover:scale-110 transition-all duration-300 cursor-pointer group p-8">
      <img
        src={postImgUrl}
        className="lg:max-w-xl rounded-2xl object-cover border shadow-xl lg:group-hover:scale-95 lg:group-hover:shadow-black/20 transition-all duration-300 ease-out"
      />
